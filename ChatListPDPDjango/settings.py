...
ROOT_URLCONF = 'ChatListPDPDjango.urls'
...
WSGI_APPLICATION = 'ChatListPDPDjango.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "telegram_users.TelegramUser": "fas fa-users-cog",
        "main.Chat": "fas fa-comments",
        "main.Feedback": "fas fa-comment-dots",
